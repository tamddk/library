...
$(document).ready(function () {
  var url_donasi = window.location.origin + "/gabut";
  _sdk_elementDonasi = () => {
    return (
      `
    <div class="_2ixjs _2ipte" donate="sodik">
    <div class="_2oewq" donate-content>
    <div class="_2ocxh">
    <div class="nyan-cat"></div>
      <div class="_2pDje _SkePP">
        <svg
          viewBox="0 0 24 24"
          width="24"
          height="24"
      ...
      <div id="load-content-donasi" class="p-6 space-y-6">
      <iframe
        id="kofiframe"
        src="` +
      url_donasi +
      `/assets/donate/index.html"
        style="width: 100%;"
        height="712"
        title="sodik"
      ></iframe>
      ...
      >
        ...
        <span>
          <a href="https://www.instagram.com/project_sodik/" target="_blank"
            >Project Sodik</a
          >
        </span>
      </div>
  ...
  _sdk_createElementDonasi = () => {
    var div = document.createElement("div");
    div.id = "donasi-for-sodik";
    div.innerHTML = _sdk_elementDonasi();
    document.body.appendChild(div);
    _sdk_trigger();
  };
  _sdk_createCssDonasi = () => {
    var css = document.createElement("link");
    css.setAttribute("rel", "stylesheet");
    css.setAttribute("href", url_donasi + "/assets/donate/donate.sodik.css");
    document.head.appendChild(css);
  };
  _sdk_triggerSound = () => {
    var sound = document.createElement("audio");
    sound.setAttribute("id", "open-donate-sound");
    sound.setAttribute(
      "src",
      url_donasi + "/assets/donate/sound/song-open-donate.mp3"
    );
    sound.setAttribute("autoplay", true);
    sound.setAttribute("loop", true);
    sound.setAttribute("class", "hidden absolute top-0");
    sound.style.display = "none";
    document.body.appendChild(sound);
  };
  _sdk_trigger = () => {
    $("[donate-sodik]").on("click", () => {
      $("[donate=sodik]").addClass("showing");
      $("[donate=sodik]").addClass("backdrop");
      $("#open-donate-sound").remove();
      _sdk_triggerSound();
    });
    $("[donate-close]").on("click", () => {
      $("#open-donate-sound").remove();
      $("[donate=sodik]").removeClass("backdrop");
      $("[donate=sodik]").removeClass("showing");
    });
  };
  setTimeout(() => {
    _sdk_createCssDonasi();
    ...
    console.log("Buy Me Coffee For Sodik");
  }, 1000);
});
